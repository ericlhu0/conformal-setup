...
def test_openai_model():
    ...
    sys_prompt = "You are a system that translates human language feedback into parameters for a " \
    "planner. The planner wants to help a robot perform tasks for the human, while making the " \
